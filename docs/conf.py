...
htmlhelp_basename = 'afl_tablesdoc'
...
latex_documents = [
    (master_doc, 'afl_tables.tex', 'afl\\_tables Documentation',
     'Michael Milton', 'manual'),
]
...
man_pages = [
    (master_doc, 'afl_tables', 'afl_tables Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'afl_tables', 'afl_tables Documentation',
     author, 'afl_tables', 'One line description of project.',
     'Miscellaneous'),
]
